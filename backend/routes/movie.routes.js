...
// GET /api/v1/movies/proxy-ts - Proxy TS segments (must be before /:id)
router.get('/proxy-ts', movieController.proxyTs);
...
// Backward-compatible "korean" routes now generate source-language AI subtitles.
