        ...
        <div className="space-y-12">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center text-center relative z-10">
                      <span className={`text-xl font-bold mb-1 ${isSelected ? "text-primaryColor" : "text-white group-hover:text-primaryColor transition-colors"}`}>
                        {pkg.label}
                      </span>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
               ...
               <div className={`p-6 rounded-2xl border transition-all cursor-pointer relative border-primaryColor bg-primaryColor/5`}> 
          ...
          <div className="mt-8">
                ...
                <div className="absolute top-0 right-0 w-64 h-64 bg-primaryColor/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
                 ...
                 <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                    ...
                    <div className="text-left space-y-2">
                       <p className="text-gray-400">Bạn đã chọn mua gói <strong className="text-white">{finalAmount > 0 ? finalAmount.toLocaleString() : "0"} Coin</strong></p>
                       <p className="text-gray-400">Tổng thanh toán: <strong className="text-primaryColor text-2xl">{((finalAmount > 0 ? finalAmount : 0) * 10).toLocaleString()} VNĐ</strong></p>
                    </div>
             ...
             {/* Messages Area */}
             {(error || success) && (
                <div className={`mt-6 p-4 rounded-xl flex items-center justify-center gap-3 animate-fade-in ${error ? "bg-red-500/10 border border-red-500/30 text-red-200" : "bg-green-500/10 border border-green-500/30 text-green-200"}`}>
                    {error ? <FiAlertCircle className="w-5 h-5 flex-shrink-0" /> : <FiCheck className="w-5 h-5 flex-shrink-0" />}
