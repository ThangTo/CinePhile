...
const NotFoundGraphicSVG = () => (
  ...
  >
    ...
    <path
      ...
      stroke="#E5E7EB"
    />
    <ellipse cx="160.123" cy="81" rx="28.0342" ry="28.0342" fill="#ffd875" />
    <path
    ...
    <path
      ...
      fill="#fde68a"
    />
    <circle cx="136.191" cy="31.0854" r="1.36752" fill="#fde68a" />
    <circle cx="141.661" cy="31.0854" r="1.36752" fill="#fde68a" />
    <circle cx="147.131" cy="31.0854" r="1.36752" fill="#fde68a" />
  </svg>
);
...
const NotFoundPage = () => {
  ...
  return (
    <section className="min-h-dvh bg-bgColor pt-[calc(var(--app-header-total-height)+1rem)]">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-8 pt-12 lg:pb-4 pb-12">
          <div className="border border-primaryColor h-[550px] rounded-lg w-full">
            <div className="p-8 flex justify-between items-center border-b border-primaryColor">
