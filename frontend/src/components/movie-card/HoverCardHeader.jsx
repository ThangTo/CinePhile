 ...
 */
const HoverCardHeader = ({ backgroundImage, title, subtitle, onClick, compact = false }) => (
  <div
    className={`relative ${
      compact ? "h-[160px]" : "h-[225px]"
  ...
  >
    ...
    <div className="absolute inset-x-0 bottom-0 px-4 pb-3">
      <h3
        ...
        } font-bold text-white mb-1 drop-shadow-lg line-clamp-2`}
      >
        {title}
      </h3>
      {subtitle && (
