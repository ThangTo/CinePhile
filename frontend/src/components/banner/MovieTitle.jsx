...
const MovieTitle = ({ title, englishTitle }) => (
  <>
    <h1 className="text-2xl sm:text-3xl font-bold md:mb-2 text-center lg:text-4xl">{title}</h1>
    <h2 className="text-sm mt-1 font-light text-primaryColor md:mb-2 text-center lg:text-md">
      {englishTitle}
    </h2>
  </>
);
