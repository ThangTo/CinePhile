      ...
      {recommendedMovies.length > 0 ? (
        <div className="space-y-2">
          {recommendedMovies.map((recommendedMovie) => (
            ...
            >
              <div className="flex-shrink-0 w-16 h-24 rounded-md overflow-hidden bg-bgColor4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-md font-semibold text-white truncate group-hover:text-primaryColor transition-colors">
